...
const generateInitialCards = () => {
  ...
  return [
    ...
    { id: 'ds1', type: 'deal_stacker', state: 'unseen', priority: 'high', hpa: 'Claim Deal', store: 'Best Buy', timeAgo: getTimeAgo(0, 1), title: 'Sony WH-1000XM5 Headphones', productImage: 'headphones', productImageUrl: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=800&q=80', brandName: 'Sony', productName: 'WH-1000XM5 Noise Cancelling', aiBackground: 'linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%)', originalPrice: 399.99, salePrice: 279.99, discount: 30, urgent: true, expiresIn: '6 hours', metaCTA: 'Swipe Right: Claim Deal Now', promoCode: 'AUDIO30', features: ['30% off', 'Free shipping', 'Extended warranty'], dataSources: [{ subject: 'FLASH SALE', from: 'deals@bestbuy.com', date: getTimeAgo(0, 1) }] },

    { id: 'ds2', type: 'deal_stacker', state: 'unseen', priority: 'low', hpa: 'Not Interested', store: 'Nordstrom', timeAgo: getTimeAgo(1), title: 'Designer Dress - Fall Collection', productImage: 'dress', productImageUrl: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=800&q=80', brandName: 'Theory', productName: 'Structured Midi Dress', aiBackground: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', originalPrice: 295.00, salePrice: 147.50, discount: 50, urgent: false, expiresIn: '3 days', metaCTA: 'Swipe Left: Dismiss', features: ['50% off', 'Free shipping', 'Free returns'], dataSources: [{ subject: 'Fall Sale', from: 'style@nordstrom.com', date: getTimeAgo(1) }] },
    ...
    { id: 'tl6', type: 'transactional_leader', state: 'unseen', priority: 'medium', hpa: 'Review Resumes', sender: { name: 'Lisa Park', initial: 'L' }, timeAgo: getTimeAgo(0, 6), title: 'Hiring Update: 3 Candidates', summary: 'Shortlist for Senior Engineer role, interviews scheduled next week', metaCTA: 'Swipe Right: Review Resumes', dataSources: [{ subject: 'Hiring Update', from: 'l.park@techcorp.com', date: getTimeAgo(0, 6) }] },
    ...
    { id: 'ei4', type: 'enterprise_innovator', state: 'unseen', priority: 'medium', hpa: 'Register for Webinar', source: { name: 'Product School', initials: 'PS' }, timeAgo: getTimeAgo(0, 5), title: 'AI Product Management Masterclass', summary: 'Live session Thursday: Integrating AI into product strategy', metaCTA: 'Swipe Right: Register Now', dataSources: [{ subject: 'Webinar Invitation', from: 'events@productschool.com', date: getTimeAgo(0, 5) }] },
    ...
    { id: 'ds3', type: 'deal_stacker', state: 'unseen', priority: 'high', hpa: 'Claim Deal', store: 'Williams Sonoma', timeAgo: getTimeAgo(0, 2), title: 'KitchenAid Artisan Stand Mixer', productImage: 'mixer', productImageUrl: 'https://images.unsplash.com/photo-1570222094114-d054a817e56b?auto=format&fit=crop&w=800&q=80', brandName: 'KitchenAid', productName: 'Artisan 5-Qt Stand Mixer', originalPrice: 449.99, salePrice: 279.99, discount: 38, urgent: true, expiresIn: '8 hours', metaCTA: 'Swipe Right: Claim Deal', promoCode: 'KITCHEN38', features: ['38% off', 'Free shipping', '10 colors available'], dataSources: [{ subject: 'Daily Deal', from: 'deals@williams-sonoma.com', date: getTimeAgo(0, 2) }] },
    
    { id: 'ds4', type: 'deal_stacker', state: 'unseen', priority: 'medium', hpa: 'Consider', store: 'REI', timeAgo: getTimeAgo(0, 4), title: 'Patagonia Nano Puff Jacket', productImage: 'jacket', productImageUrl: 'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=800&q=80', brandName: 'Patagonia', productName: 'Nano Puff Insulated Jacket', originalPrice: 249.00, salePrice: 174.30, discount: 30, urgent: false, expiresIn: '5 days', metaCTA: 'Swipe Right: Browse Sale', features: ['30% off', 'Free shipping over $50', 'Lifetime guarantee'], dataSources: [{ subject: 'Gear Sale', from: 'sales@rei.com', date: getTimeAgo(0, 4) }] },
    
    { id: 'ds5', type: 'deal_stacker', state: 'unseen', priority: 'low', hpa: 'Unsubscribe', store: 'Target', timeAgo: getTimeAgo(2), title: 'Apple AirPods Pro (2nd Gen)', productImage: 'airpods', productImageUrl: 'https://images.unsplash.com/photo-1606841837239-c5a1a4a07af7?auto=format&fit=crop&w=800&q=80', brandName: 'Apple', productName: 'AirPods Pro (2nd Generation)', originalPrice: 249.99, salePrice: 199.99, discount: 20, urgent: false, expiresIn: '7 days', metaCTA: 'Swipe Left: Not Interested', features: ['$50 off', 'Same day delivery', 'AppleCare available'], dataSources: [{ subject: 'Tech Deals', from: 'sales@target.com', date: getTimeAgo(2) }] },
